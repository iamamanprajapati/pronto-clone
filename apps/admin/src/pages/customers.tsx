...
export default function Customers() {
  ...
  return (
    <div>
      <h1>Customers</h1>
      <div className="row">
        <input style={{ width: 300 }} placeholder="Search name or phone…" value={q} onChange={e => setQ(e.target.value)} />
      </div>
      <div className="tableWrap">
        <table>
          ...
          <tbody>
            {customers.map(c => (
              <tr key={c.id} className="click" onClick={() => navigate(`/customers/${c.id}`)}>
