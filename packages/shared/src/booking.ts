...
const CANCELLABLE: BookingStatus[] = [
  'CREATED', 'PAYMENT_PENDING', 'SEARCHING', 'ASSIGNED', 'EN_ROUTE', 'ARRIVED', 'NO_EXPERT_FOUND',
];
...
export const BOOKING_TRANSITIONS: Record<BookingStatus, BookingStatus[]> = {
  ...
  COMPLETED: ['RATED'],
  RATED: [],
  NO_EXPERT_FOUND: ['SEARCHING', 'CANCELLED_CUSTOMER', 'CANCELLED_ADMIN', 'CANCELLED_SYSTEM'],
  CANCELLED_CUSTOMER: [],
  CANCELLED_WORKER: [],
  CANCELLED_ADMIN: [],
  CANCELLED_SYSTEM: [],
